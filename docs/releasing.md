...
Version **0.1.4** was published on GitHub on 24 September 2026 with drag and drop of vault paths, persistent sessions, automatic shell restart and restored output. The last completed Community review below applies to 0.1.2; the directory detects new releases automatically and queues its scan.
