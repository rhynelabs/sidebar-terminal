...
The source is published at [rhynelabs/sidebar-terminal](https://github.com/rhynelabs/sidebar-terminal). Community directory submission is pending. See GitHub Releases for available builds.
...
4. Push the source and tag. The release workflow runs the platform checks and creates a **draft** GitHub release with the three required assets.
